...
/*void Dataseed() {
	//student 1
	strcpy(Student[0].ID, "3463");
	strcpy(Student[0].Name, "Nguyen Nhat Kha");
	strcpy(Student[0].Phone, "3562436346");
	strcpy(Student[0].Email, "nk@gmail.com");
	Student[0].Age = 24;
	Student[0].Sex = Male;
	Student[0].GPA = 8.46;
	Student[0].Rank = Good;
	...
	//student 2
	strcpy(Student[1].ID, "4534");
	strcpy(Student[1].Name, "Nguyen Ngoc Bao Chau");
	strcpy(Student[1].Phone, "345344534");
	strcpy(Student[1].Email, "sm@gmail.com");
	Student[1].Age = 26;
